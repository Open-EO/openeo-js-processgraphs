...
This library's version is **1.4.2** and supports **openEO API version 1.x**.
...
More information can be found in the [**documentation**](https://open-eo.github.io/openeo-js-processgraphs/1.4.2/).

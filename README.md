...
This library's version is **1.0.0-alpha.4** and supports **openEO API version 1.0.x**.
...
<script src="https://cdn.jsdelivr.net/npm/@openeo/js-processgraphs@1.0.0-alpha.4/dist/main.min.js"></script>
```

More information can be found in the [**documentation**](https://open-eo.github.io/openeo-js-processgraphs/1.0.0-alpha.4/).